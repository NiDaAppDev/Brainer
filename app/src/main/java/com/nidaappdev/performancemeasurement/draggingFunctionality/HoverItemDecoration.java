package com.nidaappdev.performancemeasurement.draggingFunctionality;
...
public class HoverItemDecoration extends ItemTouchHelper {
    ...
    private void drawDefaultBackground(RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            ActiveGoalsAdapter.ActiveGoalsViewHolder viewHolder = (ActiveGoalsAdapter.ActiveGoalsViewHolder)parent.findContainingViewHolder(child);
