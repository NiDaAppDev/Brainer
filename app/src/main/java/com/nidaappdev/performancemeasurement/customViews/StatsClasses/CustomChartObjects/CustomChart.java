package com.nidaappdev.performancemeasurement.customViews.StatsClasses.CustomChartObjects;
...
public class CustomChart extends ConstraintLayout {
    ...
    private TextView titleTV, topStartAxisLabelTV, topEndAxisLabelTV, bottomStartAxisLabelTV, bottomEndAxisLabelTV, tipTV, lockExplanationTV;
    ...
    public CustomChart(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        top_start_axis_title = a.getString(R.styleable.CustomChart_top_start_axis_title);
        top_end_axis_title = a.getString(R.styleable.CustomChart_top_end_axis_title);
        bottom_start_axis_title = a.getString(R.styleable.CustomChart_bottom_start_axis_title);
        bottom_end_axis_title = a.getString(R.styleable.CustomChart_bottom_end_axis_title);
        ...
        topStartAxisLabelTV = findViewById(R.id.top_start_axis_title);
        topEndAxisLabelTV = findViewById(R.id.top_end_axis_title);
        bottomStartAxisLabelTV = findViewById(R.id.bottom_start_axis_title);
        bottomEndAxisLabelTV = findViewById(R.id.bottom_end_axis_title);
    ...
    private void initAxisTitles() {
        topStartAxisLabelTV.setText(top_start_axis_title);
        topEndAxisLabelTV.setText(top_end_axis_title);
        bottomStartAxisLabelTV.setText(bottom_start_axis_title);
        bottomEndAxisLabelTV.setText(bottom_end_axis_title);

        topStartAxisLabelTV.setVisibility(top_start_axis_title == null ? GONE : VISIBLE);
        topEndAxisLabelTV.setVisibility(top_end_axis_title == null ? GONE : VISIBLE);
        bottomStartAxisLabelTV.setVisibility(bottom_start_axis_title == null ? GONE : VISIBLE);
        bottomEndAxisLabelTV.setVisibility(bottom_end_axis_title == null ? GONE : VISIBLE);
    }
