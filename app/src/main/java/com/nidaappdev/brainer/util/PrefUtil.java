package com.nidaappdev.brainer.util;

import static android.content.Context.MODE_PRIVATE;
import static com.nidaappdev.brainer.App.settingsReference;
import static com.nidaappdev.brainer.util.Constants.ACHIEVED_GOALS_ASCENDING_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.ACHIEVED_GOALS_FILTERS_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.ACHIEVED_GOALS_PAGE_NAME;
import static com.nidaappdev.brainer.util.Constants.ACHIEVED_GOALS_SORT_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.ACTIVE_GOALS_PAGE_NAME;
import static com.nidaappdev.brainer.util.Constants.BRAIN_PREFERENCES_SHAREDPREFERENCES_NAME;
import static com.nidaappdev.brainer.util.Constants.MAIN_PAGE_NAME;
import static com.nidaappdev.brainer.util.Constants.SKIPPED_TUTORIAL_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.TUTORIAL_SHAREDPREFERENCES_NAME;
import static com.nidaappdev.brainer.util.Constants.ACTIVE_GOALS_ASCENDING_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.ACTIVE_GOALS_SORT_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.CURRENT_ACTIVE_GOAL_SHAREDPREFERENCES_NAME;
import static com.nidaappdev.brainer.util.Constants.CURRENT_GOAL_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.FINISHED_TUTORIAL_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.POMODORO_LENGTH_IN_MINUTES_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.POMODORO_TIME_OUT_LENGTH_IN_MINUTES_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.STARTED_BEFORE_ESTIMATION;
import static com.nidaappdev.brainer.util.Constants.SUGGEST_BREAK_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.TIMER_PREFERENCES_SHAREDPREFERENCES_NAME;
import static com.nidaappdev.brainer.util.Constants.TIMER_STATE_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.TIME_METHOD_PREFERENCE_NAME;
import static com.nidaappdev.brainer.util.Constants.TUTORIAL_STATION_INDEX_PREFERENCE_NAME;
