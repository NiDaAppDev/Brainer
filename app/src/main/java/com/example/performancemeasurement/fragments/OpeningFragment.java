...
import static com.example.performancemeasurement.activities.MainActivity.pomodoroServiceIntent;
import static com.example.performancemeasurement.activities.MainActivity.timeOutServiceIntent;
import static com.example.performancemeasurement.activities.MainActivity.timerServiceIntent;
import static com.example.performancemeasurement.util.Constants.ACTION_STOP_SERVICE;
...
import static com.example.performancemeasurement.util.Constants.POMODORO_SERVICE_POMODORO_FINISHED_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.POMODORO_SERVICE_STOP_FOR_REAL_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.POMODORO_TIME_OUT_SERVICE_TIME_OUT_FINISHED_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.SAVE_GOAL_PROGRESS_INTENT_ACTION;
import static com.example.performancemeasurement.util.Constants.SUGGEST_BREAK_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.TIMER_NOTIFICATION_SERVICE_CURRENT_GOAL_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.TIMER_NOTIFICATION_SERVICE_TIME_IN_MILLIS_EXTRA_NAME;
import static com.example.performancemeasurement.util.Constants.TIMER_NOTIFICATION_SERVICE_UPDATE_PLAY_PAUSE_BUTTON_EXTRA_NAME;
